      ...
      <div class="weather-app" style="background-image: url('${bgImage}')">
        <div class="weather-app__overlay">
          <div class="weather-app__header">
            <button id="back-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <button id="favorite-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
